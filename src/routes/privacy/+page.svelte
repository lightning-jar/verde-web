<main class="page-x-padding">
	<h1>Privacy Policy</h1>
	<p class="last-update">Last updated: April 18, 2024</p>
	<p
	...
	<ul>
		...
		<li>
			<p
				...
				Consumer Privacy Act (the &quot;CCPA&quot;) as amended by the California
		...
		<li>
			<p
				...
				to Verde Climate Solutions LLC, 1885 Saint James Place Ste 1100, Houston,
				TX 77056.</p>
		</li>
		<li>
			<p
		...
		<li>
			<p
				...
				by US regulatory authorities, in particular the U.S. Federal Trade Commission
		...
		<li>
			...
			<p
				...
				with, or could reasonably be linked, directly or indirectly, with You.</p>
		</li>
		<li>
		...
		<li>
			<p
				><strong>Website</strong> refers to Verde Climate Solutions, accessible
				from
				<a
					href="https://www.verdeclimatesolutions.com"
					rel="external nofollow noopener"
					target="_blank">https://www.verdeclimatesolutions.com</a
				></p>
		</li>
		<li>
			<p
	...
	<ul>
		...
		<li
			...
			be viewed by all users and may be publicly distributed outside.</li>
		<li
	...
	<p
		...
		visitors, users, and others who reside in the State of California.</p>
	...
	<p
		...
		collected from California residents within the last twelve (12) months.</p>
	<p
	...
	<ul>
		...
		<li>
			<p
				><strong
					>Category K: Inferences drawn from other personal information.</strong
				></p>
			<p
	...
	<p
		...
		CCPA/CPRA), which may include the following examples:</p>
	<ul>
		...
		<li
			...
			We will use that personal information to respond to Your inquiry.</li>
		<li
		...
		<li
			...
			otherwise set forth in the CCPA/CPRA.</li>
	...
	<p
		...
		please refer to the &quot;Use of Your Personal Data&quot; section.</p>
	<p
		...
		unrelated, or incompatible purposes, We will update this Privacy Policy.</p>
	...
	<p
		...
		electronic or other means, a Consumer's personal information by the Business
	...
	<p
		...
		for the business purposes described in Our Privacy Policy, and these may be
		deemed a sale under CCPA/CPRA.</p>
	<p
	...
	<p
		...
		information on other websites without their permission.</p>
	<p
		...
		&quot;right to opt-in&quot;) from either the Consumer who is between 13 and
		...
		authorized representative) may submit a request to Us by contacting Us.</p>
	<p
		...
		detail to enable Us to delete that information.</p>
	...
	<ul>
		<li
			...
			the Personal Data is being used.</li>
		<li
			><strong>The right to know/access.</strong> Under CCPA/CPRA, You have the
			right to request that We disclose information to You about Our collection,
			use, sale, disclosure for business purposes and share of personal
			information. Once We receive and confirm Your request, We will disclose to
			You:
			<ul>
		...
		<li
			><strong
				>The right to say no to the sale or sharing of Personal Data (opt-out).</strong>
			...
			section or contact Us.</li>
		<li
			><strong>The right to correct Personal Data.</strong> You have the right to
			correct or rectify any inaccurate personal information about You that We collected.
			Once We receive and confirm Your request, We will use commercially reasonable
			efforts to correct (and direct our Service Providers to correct) Your personal
			information, unless an exception applies.</li>
		<li
			><strong
				>The right to limit use and disclosure of sensitive Personal Data.</strong>
			...
			Information&quot; section or contact Us.</li>
		<li
		...
		<li
			...
			<ul>
				...
				<li
					>Providing a different level or quality of goods or services to You</li>
				<li
					>Suggesting that You will receive a different price or rate for goods
					or services or a different level or quality of goods or services</li>
			</ul>
		</li>
	</ul>
	...
	<p
		...
		sensitive information collected.</p>
	<p
	...
	<ul>
		<li>By email: info@verderclimatesolutions.com</li>
	</ul>
	<p
		...
		related to Your personal information.</p>
	...
	<p
		...
		the verifiable request's receipt.</p>
	<p
	...
	<p
		...
		Once We receive and confirm a verifiable consumer request from You, we will
		stop selling Your personal information. To exercise Your right to opt-out,
		please contact Us.</p>
	...
	<p
		...
		by an average consumer who requests such services or goods.</p>
	<p
	...
	<p
		...
		permit or require removal in certain circumstances.</p>
...
<style lang="postcss">
	...
	h2 {
		@apply font-semibold mt-10 text-18;
	}

	h3 {
		@apply font-medium mt-8 mb-2 text-18;
	}
	h4 {
		@apply font-medium mt-4 mb-2 text-16;
	}
